	...
	<tr>
		<td>
			...
			if (strcmp($folder, $my_prefs["trash_name"]) == 0)
			{
				...
				<input type="submit" class="button" name="submit" value="Empty Trash">
				<?php
			}
			else
			{
				?><input type="submit" class="button" name="submit" value="Delete"><?php
			}
			?>
		</td>
		<td class="mainLight">
			Mark as
			<input type="submit" class="button" name="submit" value="Read">
			<input type="submit" class="button" name="submit" value="Unread">
		</td>
		<td align="right">
			<?php
			...
			?>
			<select name="moveto<?php echo $main_tools_counter; ?>">
				<option value=""></option>
				<?php
				sort($folderlist);
