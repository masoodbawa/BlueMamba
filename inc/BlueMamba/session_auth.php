...
$THEME = "/images/themes/" . $DOMAIN_THEME . "/colors/" . $my_prefs["theme"] . "/";

if ( is_file(DOCUMENT_ROOT . $THEME . "theme.php") == false )			// Does theme exist?
{	
	$THEME = "/images/themes/" . $DOMAIN_THEME . "/colors/default/";
}

include(DOCUMENT_ROOT . $THEME . "theme.php");
