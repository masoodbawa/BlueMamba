...
function splchk_showform($positions, $words, $str)
{
	...
	echo "</table><br>\n";
	echo '<input type="submit" class="button" name="correct_spelling" value="'.$str["correct"].'">';
	echo '<input type="submit" class="button" name="no_changes" value="'.$str["nochange"].'">';
}
