...
/*********************************************************************
  ...
  Author:   Travis Schanafelt
    ...
    Document: read_message_handler.php
...
*********************************************************************/
	...
	if( ($typeCode == 3) && (strcasecmp($subtype, "ms-tnef") == 0) )
	{
		// Ms-tnef
		$type = $dummy;
		include_once(dirname(__FILE__) . "/tnef_decoder.php");
		include(dirname(__FILE__) . "/read_tnef_print.php");
	}
	elseif($typeCode == 0)
	{
		// Major type is "TEXT"
		...
		if(strcasecmp($subtype, "HTML") == 0)
		{
			...
			{
				include(dirname(__FILE__) . "/read_message_print.php");
			}
			else
			{
