...
include("inc/BlueMamba/header_main.php");
include("inc/BlueMamba/icl.php");
include("conf/defaults.php");

include("inc/BlueMamba/options_menu.php");
...
<table border="0" width="95%" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td align="right">
			...
			<input type="submit" class="button" name="revert" value="Defaults">
		</td>
	</tr>
</table>
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr valign="top">
		<td width="50%">
			...
			<table border="0" cellspacing="0" cellpadding="5" bgcolor="<?=$my_colors["main_hilite"]?>" width="100%" height="100%">
				<tr class="tblheader">
				...
				<tr>
					<td bgcolor="<?=$my_colors["main_bg"]?>">
						...
						<table border="0" cellspacing="0" cellpadding="5" width="100%">
							<tr>
								<td>
									Name: <a href="options_identities.php?user=<?php echo $user;?>"><?php echo ($my_prefs["user_name"]?$my_prefs["user_name"]:"Unspecified"); ?></a>
									<input type=hidden name="user_name" value="<?php echo $my_prefs["user_name"]; ?>">
									<br>
									Email: <a href="options_identities.php?user=<?php echo $user;?>"><?php echo ($my_prefs["email_address"]?$my_prefs["email_address"]:"Unspecified"); ?></a>
									<input type=hidden name="email_address" value="<?php echo $my_prefs["email_address"]; ?>">
								</td>
							</tr>
							<tr>
								<td>
									<textarea name="signature1" class="textbox" rows=5 cols=30><?php echo $my_prefs["signature1"]; ?></textarea>
								</td>
							</tr>
							<tr>
								<td>
									<input type="checkbox" name="show_sig1" value="1" <?php echo ($my_prefs["show_sig1"]==1?"CHECKED":""); ?>> Show signature by default
								</td>
							</tr>
						</table>
			...
			<table border="0" cellspacing="0" cellpadding="5" bgcolor="<?=$my_colors["main_hilite"]?>" width="100%">
				<tr class="tblheader">
				...
				<tr>
					<td bgcolor="<?=$my_colors["main_bg"]?>">
						...
						<table border="0" cellspacing="0" cellpadding="5">
							<tr>
								<td>
									<input type="checkbox" name="showNav" value="1" <?php echo ($my_prefs["showNav"]==1?"CHECKED":""); ?>>
								</td>
								<td>
							...
							<tr>
								<td>
									<input type="checkbox" name="nav_no_flag" value="1" <?php echo ($my_prefs["nav_no_flag"]==1?"CHECKED":""); ?>>
								</td>
								<td>
							...
							<tr>
								<td>
									<input type="checkbox" name="html_in_frame" value="1" <?php echo ($my_prefs["html_in_frame"]==1?"CHECKED":""); ?>>
								</td>
								<td>
							...
							<tr>
								<td>
									<input type="checkbox" name="show_images_inline" value="1" <?php echo ($my_prefs["show_images_inline"]==1?"CHECKED":""); ?>>
								</td>
								<td>
									Show images inline.
								</td>
							...
							<tr>
								<td>
									<input type="checkbox" name="colorize_quotes" value="1" <?php echo ($my_prefs["colorize_quotes"]==1?"CHECKED":""); ?>>
								</td>
								<td>
									Colorize quotes.
								</td>
							...
							<tr>
								<td>
									<input type="checkbox" name="detect_links" value="1" <?php echo ($my_prefs["detect_links"]==1?"CHECKED":""); ?>>
								</td>
								<td>
							...
							<tr>
								<td>
									<input type="checkbox" name="subject_edit" value="1" <?php echo ($my_prefs["subject_edit"]==1?"CHECKED":""); ?>>
								</td>
								<td>
							...
							<tr>
								<td>
									<input type="checkbox" name="advanced_controls" value="1" <?php echo ($my_prefs["advanced_controls"]==1?"CHECKED":""); ?>>
								</td>
								<td>
									Advanced controls
								</td>
				...
				<tr>
					<td bgcolor="<?=$my_colors["main_bg"]?>">
						...
						<table border="0" cellspacing="1" cellpadding="2">
							<tr>
								<td>
									Show up to <input type=text class="textbox" name="view_max" value="<?php echo $my_prefs["view_max"]; ?>" size="3"> items
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td>
									Check for new messages every <input type="text" class="textbox" name="radar_interval" value="<?php echo $my_prefs["radar_interval"] ?>" size="4"> minutes
								</td>
							</tr>
							<tr>
								<td>
				...
				<tr>
					<td bgcolor="<?=$my_colors["main_bg"]?>">
						...
						<table border="0" cellspacing="0" cellpadding="5">
							<tr>
								<td>
									<input type="checkbox" name="showNumUnread" value="1" <?php echo ($my_prefs["showNumUnread"]==1?"CHECKED":""); ?>>
								</td>
								<td>
							...
							<tr>
								<td>
									<input type="checkbox" name="refresh_folderlist" value="1" <?php echo ($my_prefs["refresh_folderlist"]==1?"CHECKED":""); ?>>
								</td>
								<td>
									Refresh folder list every &nbsp;<input type="text" class="textbox" name="folderlist_interval" value="<?php echo $my_prefs["folderlist_interval"] ?>" size="4">&nbsp; minutes.
								</td>
							</tr>
						</table>
				...
				<tr>
					<td bgcolor="<?=$my_colors["main_bg"]?>">
						...
						<table border="0" cellspacing="0" cellpadding="5">
							<tr>
								<td>
									<input type="checkbox" name="compose_html" value="1" <?php echo ($my_prefs["compose_html"]==1?"CHECKED":""); ?>>
								</td>
								<td>
							...
							<tr>
								<td>
									<input type="checkbox" name="showCC" value="1" <?php echo ($my_prefs["showCC"]==1?"CHECKED":""); ?>>
								</td>
								<td>
									Show CC/BCC fields.
								</td>
							...
							<tr>
								<td>
									<input type="checkbox" name="closeAfterSend" value="1" <?php echo ($my_prefs["closeAfterSend"]==1?"CHECKED":""); ?>>
								</td>
								<td>
									Close after sending.
								</td>
							...
							<tr>
								<td colspan="2">
									&nbsp;Show contacts in <select name="showContacts">
										<option value="0" <?php echo ($my_prefs["showContacts"]==0?"SELECTED":""); ?>>None
										<option value="1" <?php echo ($my_prefs["showContacts"]==1?"SELECTED":""); ?>>Popup Window
										<option value="2" <?php echo ($my_prefs["showContacts"]==2?"SELECTED":""); ?>>Compose Window
									</select>
								</td>
							</tr>
						</table>
