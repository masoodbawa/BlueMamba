...
include("inc/BlueMamba/identities.php");
include("inc/BlueMamba/data_manager.php");
					...
					<table border="0" cellspacing="0" cellpadding="5" bgcolor="<?=$my_colors["main_hilite"]?>" width="100%">
						...
						while(list($k, $v) = each($identities_a) )
						{
							...
							<tr bgcolor="<?=$my_colors["main_bg"]?>">
								<td valign="middle">
									<a href="options_identities.php?user=<?=$user?>&edit=<?php echo $v["id"]; ?>">Edit</a>
								</td>
								<td valign="middle">
									<nobr><a href="compose.php?user=<?=$user?>&sender_identity_id=<?php echo $v["id"]; ?>" target="<?php echo $target; ?>"><?php echo $v["name"]." ".($v["default"]?"(Default)":""); ?></a></nobr>
								</td>
								<td valign="middle"><?php echo $v["email"];   ?></td>
								<td valign="middle"><?php echo $v["replyto"]; ?></td>
							</tr>
							<tr bgcolor="<?=$my_colors["main_bg"]?>">
								<td colspan="4" valign="middle"><pre><?php echo stripslashes($v["sig"]); ?></pre></td>
							</tr>
							<tr>
										...
										<td align="left">
											...
											<table>
												<tr>
													...
													<td><input type="text" name="edit_name" class="textbox" value="<?php echo $v["name"]?>" size="45"></td>
												</tr>
												<tr>
													<td align="right">Email:</td>
													<td><input type="text" name="edit_email" class="textbox" value="<?php echo $v["email"] ?>" size="45"></td>
												</tr>
												<tr>
													<td align="right">Reply To:</td>
													<td><input type="text" name="edit_replyto" class="textbox" value="<?php echo $v["replyto"] ?>" size="45"></td>
												</tr>
											</table>
							
											<table>
												<tr>
													<td><textarea name="edit_sig" class="textbox" cols="74" rows="5"><?php echo htmlspecialchars(stripslashes($v["sig"]))?></textarea></td>
												</tr>
												<tr>
													<td><input type="checkbox" name="new_default" value="1" <?php echo ($v["default"]?"checked":"") ?>> Set to default</td>
												</tr>
											</table>
							
											<table width="100%">
												<tr>
													<td align="left"><input type="submit" class="button" name="save" value="Save Identity"></td>
													<td align="right"><input type="submit" class="button" name="delete" value="Delete Identity"></td>
												</tr>
											</table>
									...
									<tr>
										<td align="left">
											...
											<table>
												<tr>
													<td align="right">Name:</td>
													<td><input type="text" name="new_name" class="textbox" value="<?php echo stripslashes($new_name)?>" size="45"></td>
												</tr>
												<tr>
													<td align="right">Email:</td>
													<td><input type="text" name="new_email" class="textbox" value="<?php echo $new_email; ?>" size="45"></td>
												</tr>
												<tr>
													<td align="right">Reply To:</td>
													<td><input type="text" name="new_replyto" class="textbox" value="<?php echo $new_replyto; ?>" size="45"></td>
												</tr>
											</table>
											
											<table>
												<tr>
													<td><textarea name="new_sig" class="textbox" cols="74" rows="5"><?php echo htmlspecialchars(stripslashes($new_sig))?></textarea></td>
												</tr>
												<tr>
											...
											<table width="100%">
												<tr>
													<td align="left"><input type="submit" class="button" name="add" value="Add Identity"></td>
												</tr>
											</table>
