...
include("inc/BlueMamba/calendar.php");
include_once("inc/BlueMamba/common.php");
...
include_once("inc/BlueMamba/idba.php");
include_once("inc/BlueMamba/array2sql.php");
	...
	<table border="0" cellspacing="0" cellpadding="5" width="100%">
		<tr>
			<td bgcolor="<?=$my_colors["main_head_bg"] ?>">
				&nbsp; <span class="tblheader"><?php echo ($edit>0?"Edit":"Add"); ?> Schedule</span>
			...
			<td bgcolor="<?=$my_colors["main_bg"]?>" align="center">
				...
				<table border="0">
					<tr>
						...
						<td><input type="text" name="title" class="textbox" value="<?php echo $title ?>"></td>
					...
					<tr>
						...
						<td align="left">
							<input type="text" name="start_month" class="textbox" value="<?php echo $start_month ?>" size="2"> /
							<input type="text" name="start_day" class="textbox" value="<?php echo $start_day ?>" size="2"> /
							<input type="text" name="start_year" class="textbox" value="<?php echo $start_year ?>" size="4">
						</td>
						<td align="right">Ends on:</td>
						<td align="left">
							<input type="text" name="end_month" class="textbox" value="<?php echo $end_month ?>" size="2"> / 
							<input type="text" name="end_day" class="textbox" value="<?php echo $end_day ?>" size="2"> / 
							<input type="text" name="end_year" class="textbox" value="<?php echo $end_year ?>" size="4">
						</td>		
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="left" valign="top">
							<input type="checkbox" name="repeat_d[0]" value=1 <?php echo ($repeat_d[0]?"CHECKED":"") ?>> Sunday<br>
							<input type="checkbox" name="repeat_d[1]" value=1 <?php echo ($repeat_d[1]?"CHECKED":"") ?>> Monday<br>
							<input type="checkbox" name="repeat_d[2]" value=1 <?php echo ($repeat_d[2]?"CHECKED":"") ?>> Tuesday<br>
							<input type="checkbox" name="repeat_d[3]" value=1 <?php echo ($repeat_d[3]?"CHECKED":"") ?>> Wednesday<br>
							<input type="checkbox" name="repeat_d[4]" value=1 <?php echo ($repeat_d[4]?"CHECKED":"") ?>> Thursday<br>
							<input type="checkbox" name="repeat_d[5]" value=1 <?php echo ($repeat_d[5]?"CHECKED":"") ?>> Friday<br>
							<input type="checkbox" name="repeat_d[6]" value=1 <?php echo ($repeat_d[6]?"CHECKED":"") ?>> Saturday
						</td>
						<td align="right" valign="top">of every</td>
						<td align="left" valign="top">
							<input type="checkbox" name="repeat_w[1]" value="1" <?php echo ($repeat_w[1]?"CHECKED":"") ?>> first week<br>
							<input type="checkbox" name="repeat_w[2]" value="1" <?php echo ($repeat_w[2]?"CHECKED":"") ?>> second week<br>
							<input type="checkbox" name="repeat_w[3]" value="1" <?php echo ($repeat_w[3]?"CHECKED":"") ?>> third week<br>
							<input type="checkbox" name="repeat_w[4]" value="1" <?php echo ($repeat_w[4]?"CHECKED":"") ?>> fourth week<br>
							...of every month.
							<br> <br>
					...
					<tr>
						<td align="right"></td>
						<td align="left" colspan="3">
							<input type="checkbox" name="repeat_monthly" value="1" <?php echo ($repeat_monthly?"CHECKED":""); ?>> Repeat Monthly<br>
							<input type="checkbox" name="repeat_yearly"  value="1" <?php echo ($repeat_yearly?"CHECKED":"");  ?>> Repeat Annually
						</td>
					</tr>
					<tr>
						<td align="right">&nbsp;</td>
				...
				<table width="50%">
					<tr>
						<td align="left"><input type="submit" class="button" name="edit_cal" value="<?php echo ($edit>0?"Save":"Add"); ?> Schedule"></td>
						<td align="right"><?php if($edit>0){echo '<input type="submit" class="button" name="delete_cal" value="Delete Schedule">';} ?></td>
					</tr>
				</table>
