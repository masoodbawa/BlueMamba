...
include("inc/BlueMamba/ryosdates.php");
...
include("inc/BlueMamba/filters.php");
	...
	if(isset($submit))
	{
		...
		if(strcmp($submit, "Delete") == 0)
		{
			...
			if($folder != "Trash")
			{
				if(iil_C_Move($conn, $messages, $folder, "Trash") >= 0)
				{
					$delete_success = true;
				}
				else
	...
	<table border="0" cellspacing="0" cellpadding="5" width="100%" height="26">
		<tr>
			<td align="left" valign="middle">
				...
				$disp_folderName = str_replace("", "", $folder);
	...
	if(count($headers) > 0)
	{
		...
		if(sizeof($headers)>0)
		{
			...
			{
				include("inc/BlueMamba/main_tools.php");
			}
