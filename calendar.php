...
include("inc/BlueMamba/version.php");
...
{
	include("inc/BlueMamba/edit_calendar.php");
}
...
if($backend_result)	// If query returned
{
	...
	<table border="0" cellspacing="0" cellpadding="5" width="100%">
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%" class="bigTitle">
					<tr>
						...
						<td align="center" class="mainHeading">
							<a href="calendar.php?user=<?php echo $user ."&date=".date("Ymd",$last_ts)."&mode=$mode";?>">
							<img src="<?php echo $THEME; ?>leftarrow.gif" border="0" align="texttop"></a>
							&nbsp; &nbsp; 
							<span class="bigTitle">
								<?php
							...
							&nbsp; &nbsp; 
							<a href="calendar.php?user=<?php echo $user ."&date=".date("Ymd",$next_ts)."&mode=$mode"; ?>">
							<img src="<?php echo $THEME; ?>rightarrow.gif" border="0" align="texttop"></a>
						</td>
						<td width="100">&nbsp;
		...
		echo "<p>";
		echo '<table width="95%" border="0" cellspacing="0" cellpadding="5" bgcolor="'.$my_colors["main_hilite"].'">';
...
<table cellspacing=0 cellpadding=2>
	<tr>
		<td bgcolor="<?=$my_colors["main_head_bg"] ?>" valign="middle">
			&nbsp;
			<a class="mainHeading" href="calendar.php?user=<?=$user?>&date=<?php echo formatCalDate($current_month, $current_day, $current_year-1); ?>">&lt;&lt;</a>
			&nbsp; &nbsp;
			<a class="mainHeading" href="calendar.php?user=<?=$user?>&date=<?php echo formatCalDate($prev_month, $current_day, $prev_year); ?>">&lt;</a>
			&nbsp;
		</td>
		...
		<td bgcolor="<?=$my_colors["main_head_bg"] ?>" valign="middle">
			&nbsp;
			<a class="mainHeading" href="calendar.php?user=<?=$user?>&date=<?php echo formatCalDate($next_month, $current_day, $next_year); ?>">&gt;</a>
			&nbsp; &nbsp;
			<a class="mainHeading" href="calendar.php?user=<?=$user?>&date=<?php echo formatCalDate($current_month, $current_day, $current_year+1); ?>">&gt;&gt;</a>
			&nbsp;
		</td>
...
<table wdith="95%" cellspacing="10">
	<tr>
		<td valign="top">
			...
			$month = $prev_month;
			$year = $prev_year;
			include("inc/BlueMamba/display_monthly_calendar.php");
			?>
		</td>
		<td valign="top">
			<?php
