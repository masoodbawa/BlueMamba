	...
	<tr>
		<td height="40">
			...
			<table width="100%" height="40" border="0" cellspacing="0" cellpadding="0">
				<tr> 
					<td width="25" bgcolor="<?php echo $my_colors['tool_bg']; ?>" align="center" valign="middle" class="top">&nbsp;
						
					</td>
					<td bgcolor="<?php echo $my_colors['tool_bg']; ?>" valign="middle" class="top">
						Welcome to Webmail 
					</td>
				</tr>
			</table>
						...
						<table width="100%" height="100%" border="0" cellpadding="2" cellspacing="0" class="text">
							...
							<tr> 
								<td class="version">
									...
									WebMail Version <?php echo $version; ?>
								</td>
								<td class="version" width="20">
									<a href="?user=<?php echo $_GET['user']; ?>">Next_Tip</a>
								</td>
