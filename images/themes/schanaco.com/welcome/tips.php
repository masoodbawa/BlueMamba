...
(
	...
	<br> <br>
	<a href=\"../../../main.php?folder=Sent&user=". $user ."\" target=\"list2\">Go to your Sent folder</a>
	",
	...
	<br> <br>
	<a href=\"../../../main.php?folder=Trash&user=". $user ."\" target=\"list2\">Go to your Trash folder</a>
	",
